...
if __name__ == "__main__":
    ...
    parser.add_argument('--DTU', type=str,  default='Offical_DTU_Dataset', help='/sci/labs/sagieb/zlilovadia/KnotSurface/DTU/')
    ...
    cmd = f"{python_executable} {script_dir}/eval.py --data {result_mesh_file} --scan {scan} --mode mesh --dataset_dir {Offical_DTU_Dataset} --vis_out_dir {out_dir}"
    os.system(cmd)